...
export default function ProfilePage() {
  ...
  return (
    <div>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Profile | React+NestJs User Mangement</title>
      </Helmet>
        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-6 sm:px-6 lg:px-8 lg:pb-16">
          <div className="overflow-hidden rounded-lg bg-white shadow">
            <div className="divide-y relative divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
              ...
              <div className="relative divide-y divide-gray-200 lg:col-span-9">
                <div
                  className=" z-5 absolute top-5 cursor-pointer right-5"
                  onClick={() => {
